...
import 'package:electronic_queue/presentation/pages/login_view.dart';
import 'package:electronic_queue/presentation/pages/register_page.dart';
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Image(
                image: AssetImage('assets/image/Logo_1.png'),
              ),
              const SizedBox(
                height: 30,
              ),
              ...
              ElevatedButton(
                onPressed: () {
                  //                            Войти
                  Routes.instance
                      .push(widget: const NewRegisterPage(), context: context);
                },
                style: ButtonStyle(
              ...
              GestureDetector(
                onTap: () {
                  Routes.instance
                      .push(widget: const RegisterPage(), context: context);
                },
                child: Text(
